...
const WEEK: Day[] = [
  {
    ...
    exercises: [
      ...
      { name: "Back extension machine", scheme: "3 × 10–12" },
      { name: "Hip thrust / glute drive", scheme: "3 × 8–12" },
      { name: "Standing calf raise", scheme: "4 × 10–12" },
      { name: "Seated calf raise", scheme: "3 × 15–20" },
    ],
