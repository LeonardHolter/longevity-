...
const WEEK: Day[] = [
  {
    ...
    type: "lift",
    exercises: [
      { name: "Machine incline press", scheme: "4 × 6–10" },
      { name: "Pec deck fly", scheme: "3 × 12–15" },
      { name: "Machine shoulder press", scheme: "3 × 8–12" },
    ...
    notes: "Retract shoulder blades, pin them to the pad. No pressing with rounded upper back.",
  },
  {
    id: "tue",
    label: "Tuesday",
    ...
    exercises: [
      ...
      { name: "Face pulls", scheme: "4 × 15–20" },
      { name: "Incline DB curl", scheme: "3 × 10–12" },
      { name: "Hammer curl", scheme: "3 × 10–12" },
    ],
    notes: "Posture day. Cable rows: chest up, squeeze shoulder blades 1 sec each rep. Face pulls: external rotation at top, pull to forehead, pause.",
  },
  {
    id: "wed",
    label: "Wednesday",
    ...
    exercises: [
      ...
      { name: "Back extension (plate to chest)", scheme: "3 × 10–12" },
      { name: "Seated calf raise", scheme: "4 × 12–20" },
      { name: "Weighted cable crunch", scheme: "4 × 10–12" },
      { name: "Hanging leg raises", scheme: "3 × 10–12" },
      { name: "Pallof press", scheme: "3 × 10/side" },
    ],
    notes: "Hip thrusts fix anterior tilt — strong glutes pull pelvis into neutral. Slow pause at bottom on calf raises.",
  },
  {
    id: "thu",
    label: "Thursday",
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: "Weighted cable crunch", scheme: "3 × 12–15" },
      { name: "Dead bug", scheme: "3 × 8/side" },
      { name: "Side plank", scheme: "3 × 30–45 sec/side" },
      { name: "Chin tucks", scheme: "3 × 12" },
      { name: "Wall slides", scheme: "3 × 10" },
      { name: "Couch stretch", scheme: "2 min/side" },
      { name: "Doorway pec stretch", scheme: "1 min/side" },
    ],
    notes: "Dead bug: hard posterior pelvic tilt — flatten low back into floor. Chin tucks: hold 3 sec, strengthens deep neck flexors. Wall slides: keep wrists and elbows on the wall.",
  },
];
